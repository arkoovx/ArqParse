...
from arqparse.config.settings import BASE_DIR, TASKS, CHROME_UA
from arqparse.utils.path_manager import normalize_task_paths
...
def _default_settings():
    ...
    return {
        ...
        "auto_update": True,  # По умолчанию включено
...
def load_settings():
    ...
    try:
        ...
        if "auto_update" not in data:
            data["auto_update"] = defaults["auto_update"]
